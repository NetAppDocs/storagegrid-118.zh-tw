...
** 瀏覽至 `_primary Admin Node IP address_/metrics/graph` 並輸入下列查詢： `node_network_mtu_bytes{device="eth0"}`
...
*** https://docs.netapp.com/us-en/storagegrid-appliances/sg110-1100/changing-link-configuration-of-services-appliance.html["SG110 和 SG1100"^]
