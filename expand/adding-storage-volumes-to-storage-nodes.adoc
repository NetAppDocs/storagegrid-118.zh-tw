...
NOTE: 這些說明僅適用於軟體型儲存節點。請參閱 https://docs.netapp.com/us-en/storagegrid-appliances/sg6000/adding-expansion-shelf-to-deployed-sg6060.html["新增擴充櫃至已部署的SG6060"^] 瞭解如何安裝擴充櫃、將儲存磁碟區新增至SG6060。其他應用裝置儲存節點無法擴充。
