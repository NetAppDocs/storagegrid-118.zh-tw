...
這些指示說明 StorageGRID 11.8 的新功能、並提供逐步說明、協助您將 StorageGRID 系統中的所有節點升級至新版本。



== 開始之前

請檢閱這些主題、瞭解 StorageGRID 11.8 的新功能和增強功能、判斷是否已過時或移除任何功能、以及瞭解 StorageGRID API 的變更。

* link:whats-new.html["StorageGRID 11.8 的新功能"]
